...
ale={'Aquatics': 'Aquatics', 'Athletics': 'Athletics', 'Badminton': 'Badminton', 'Basketball': 'Basketball', 'Boxing': 'Boxing', 'Chess': 'Chess', 'Cricket': 'Cricket', 'Football': 'Football', 'Handball': 'Handball', 'Hockey': 'Hockey', 'Kabaddi': 'Kabaddi', 'Khokho': 'Khokho', 'LawnTennis': 'Lawn Tennis', 'Squash': 'Squash', 'TableTennis': 'Table Tennis', 'Taekwondo': 'Taekwondo', 'Volleyball': 'Volleyball', 'Weightlifting': 'Weightlifting'}
...
<div class="home">
	<div class="navbar">
		...
		<div class="links">
			...
			<div (click)="scrolling('contacts')" class="l">
				Contacts
			</div>
			<div class="l">
				Feedback
...
title ="""<div class="title" id='contacts'>Captains and Vice-Captains</div>"""
icons = """<div>
...
for sport in sports:
	...
	if sport == "Khokho":
		...
		print(a1+ale[sport]+dict4[sport])
	print(title)
...
for sport in sports:
  ...
  constructor(private titleService: Title, private metaService: Meta,private scroll : ViewportScroller) { this.titleService.setTitle('"""+ale[sport]+"""');
  """ +"""this.metaService.addTags([
      {name: 'keywords', content:'IIT (BHU),"""+ale[sport]+"""'},
      {name: 'description', content: 'IIT (BHU) Varanasi """+ale[sport]+""" teams website page, list of captains and vice-captains and links to the clubs social media'},
